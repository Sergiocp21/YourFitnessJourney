    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**")
                        .allowedOrigins("http://localhost:5173") // Allow frontend access from localhost
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    corsVar.setAllowedOrigins(List.of("http://localhost:5173")); // Allow frontend origin
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/backend/access, /backend/getUser").permitAll() // Allow access to endpoints
